...
const coincap = new Witnet.Source("https://api.coincap.io/v2/assets")
  ...
  .get("data")
  .asArray()
  .filter(new Witnet.Script([Witnet.TYPES.ARRAY, Witnet.TYPES.BYTES])
    .get("symbol")
    .asString()
    .match({ "BTC": true, "ETH": true, "XRP": true, "LTC": true }, false)
  ).sort(new Witnet.Script([Witnet.TYPES.ARRAY, Witnet.TYPES.STRING])
    .get("symbol")
  ).map(new Witnet.Script([Witnet.TYPES.ARRAY, Witnet.TYPES.BYTES])
